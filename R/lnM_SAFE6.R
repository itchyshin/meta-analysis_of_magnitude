                            ...
                            B = 1e5, chunk = 5e3)
{
  ...
  out <- bind_rows(
    data.frame(method = "Delta-1",        lnM = delta["point"], Var = delta["var"]),
...
# Independent example
compare_methods(x1 = 15.3, x2 = 11.1,
                s1 = 2.7,  s2 = 2.1,
                n1 = 40,   n2 = 40,
                B  = 1e5, chunk = 4000)

# Independent example
compare_methods(x1 = 15.3^2, x2 = 11.1^2,
                s1 =  sqrt((2.7^2*15.3^2)*4),  s2 =  sqrt((11.1^2 * 2.1^2)*4),
                n1 = 40,   n2 = 40,
                B  = 1e5, chunk = 4000)

# Paired example (r = 0.8)
compare_methods(x1 = 21.3, x2 = 11.1,
                s1 = 2.7,  s2 = 2.1,
                n1 = 12,   r  = 0.8,
                B  = 1e5, chunk = 4000)